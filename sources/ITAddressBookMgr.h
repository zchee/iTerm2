...
#define KEY_EAST_ASIAN_FONT        @"East Asian Font"
#define KEY_PUA_FONT               @"PUA Font"
...
#define KEY_USE_EAST_ASIAN_FONT    @"Use East Asian Font"
#define KEY_EAST_ASIAN_ALIASED     @"East Asian Font Anti Aliased"
#define KEY_USE_PUA_FONT           @"Use PUA Font"
#define KEY_PUA_ALIASED            @"PUA Font Anti Aliased"
